...
export const MOCK_MENU_ITEMS: Record<string, SerializedMenuItem[]> = {
  "zestora": [
    ...
    ["Shawarma", "Toasted wrap filled with seasoned chicken, crunchy vegetables, and creamy sauce.", 3000, "Wraps", "/images/zestora/Shawarma.jpeg"],
    ["Chips", "Golden crunchy potato chips served with a signature dip.", 1800, "Sides", "/images/zestora/Chips.jpeg"],
    ["Samosa", "Crisp pastry pockets filled with spiced vegetables and beef.", 1500, "Small Chops", "/images/zestora/Samosas.jpeg"],
    ["Spring Roll", "Crispy rolls filled with vegetables and lightly seasoned chicken.", 1500, "Small Chops", "/images/zestora/Spring-roll.jpeg"],
    ["Meat Pie", "Buttery baked pastry filled with minced beef, potatoes, and carrots.", 1200, "Pastries", "/images/zestora/Meat-pie.jpeg"],
    ["Egg Roll", "Soft golden pastry wrapped around a whole seasoned egg.", 1000, "Pastries", "/images/zestora/Egg-roll.jpeg"],
    ["Smoothie", "Fresh blended fruit smoothie served chilled.", 2500, "Drinks", "/images/zestora/Smoothie.jpeg"],
    ["Ice Cream", "Cool creamy scoops with your choice of daily flavors.", 2200, "Desserts", "/images/zestora/Ice-cream.jpeg"],
    ["Milkshake", "Thick vanilla, chocolate, or strawberry shake topped with cream.", 2800, "Drinks", "/images/zestora/Milk-shake.jpeg"],
    ["Orange Juice", "Freshly squeezed orange juice served chilled.", 1800, "Drinks", "/images/zestora/Orange-juice.jpeg"],
    ["Zobo Drink", "Refreshing hibiscus drink infused with ginger, pineapple, and cloves.", 1200, "Drinks", "/images/zestora/Zobo-drink.jpeg"],
    ["Watermelon Juice", "Naturally sweet watermelon juice blended fresh and served cold.", 1600, "Drinks", "/images/zestora/Water-melon-juice.jpeg"],
    ["Pineapple Juice", "Bright and refreshing pineapple juice made from ripe fruit.", 1600, "Drinks", "/images/zestora/Pineapple-juice.jpeg"],
    ["Tiger Nut Drink", "Creamy, naturally sweet tiger nut drink served chilled.", 1800, "Drinks", "/images/zestora/Tiger-nut-drink.jpeg"],
    ["Soft Drinks", "Chilled assorted soft drinks served cold.", 1000, "Drinks", "/images/zestora/Soft-drinks.jpeg"],
    ["Mocktails", "Refreshing non-alcoholic fruit mocktails made to order.", 2500, "Drinks", "/images/zestora/Mocktails.jpeg"],
    ["Fried Egg", "Freshly fried eggs seasoned and served warm.", 1000, "Extras", "/images/zestora/Fried-egg.jpeg"],
    ["French Fries", "Classic thin-cut fries, hot and lightly salted.", 1800, "Sides", "/images/zestora/French-fries.jpeg"],
    ["Burger", "Juicy beef burger with lettuce, tomato, cheese, and house sauce.", 4000, "Burgers", "/images/zestora/Burger.jpeg"],
    ["Plantain", "Sweet ripe plantain fried until golden and caramelized.", 1800, "Sides", "/images/zestora/Plantains.jpeg"],
    ["Pizza", "Cheesy oven-baked pizza with pepperoni, peppers, and herbs.", 6500, "Pizza", "/images/zestora/Pizza.jpeg"],
    ...
    ["Fruit Salad", "A bright cup of seasonal watermelon, pineapple, melon, and grapes.", 2400, "Healthy", "/images/zestora/Fruit-salad.jpeg"],
